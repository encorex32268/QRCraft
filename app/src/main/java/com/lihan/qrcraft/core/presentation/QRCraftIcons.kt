package com.lihan.qrcraft.core.presentation
...
val Flash: ImageVector
    @Composable get() = ImageVector.vectorResource(R.drawable.flash)

val FlashOff: ImageVector
    @Composable get() = ImageVector.vectorResource(R.drawable.flash_off)
...
val Text: ImageVector
    @Composable get() = ImageVector.vectorResource(R.drawable.text)
